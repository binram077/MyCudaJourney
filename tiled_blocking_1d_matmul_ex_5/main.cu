...
int main() {
    const int n = 1024;
    const int TileHeight = 64, TileWidth = 8;
    ...
    dim3 gridSize(n / TileHeight, n / TileHeight, 1);
    dim3 blockSize(TileHeight * TileWidth, 1, 1);
    ...
    for (int i = 0; i < numRuns; i++) {
        ...
        matmul<TileHeight, TileWidth><<<gridSize, blockSize>>>(d_a, d_b, d_c, n);
